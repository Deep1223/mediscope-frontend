...
export function convertSubmissionToArticle(submission) {
  return {
    _id: submission._id, // Add _id for ArticleCard compatibility
    id: submission._id,
    ...
    authors: submission.authors || [], // Keep authors as array for ArticleCard
    ...
    type: "research",
    articletype: submission.articletype || "Original Research", // Add articletype field
