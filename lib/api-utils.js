...
export async function searchArticles(params = {}) {
  ...
  const queryString = queryParams.toString()
  const endpoint = `https://brockersbackend.finnovationz.com/api/article/public/search${queryString ? `?${queryString}` : ''}`
...
export async function getFilterOptions() {
  try {
    const response = await fetch('https://brockersbackend.finnovationz.com/api/article/public/filters')
